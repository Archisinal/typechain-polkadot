...
```bash
npm i -D @archisinal/typechain-polkadot
```
...
```bash
npx @archisinal/typechain-polkadot --input path/to/abis --output path/to/output
```
...
```bash
npx @archisinal/typechain-polkadot --input path/to/abis --output path/to/output --plugins ./plugins-directory
```
